...
> **상태:** BE API 구현 완료 (2026-05) — **AI Worker 연동 구현 완료** (2026-05)  
...
1. BE `POST /api/callbacks/ai/submissions/{submissionId}/result` 배포  
2. [x] AI submit 백그라운드 직후 `result` 1회  
3. [x] AI N9 direct write(`scores`, `submission_runs`, `submissions.status`) 정리  
