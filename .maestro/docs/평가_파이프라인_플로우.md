...
| `intent_analyzer` | N2 | 의도·가드레일·제출 플래그 | `messages`, `human_message`, `problem_context` | `intent_status`, `is_guardrail_failed`, `is_submitted`, `unified_intent`, `guide_strategy` 등 |
