...
NODE_TAGS = {
    ...
    TRACE_NAME_CODE_PERFORMANCE: [TAG_EVALUATION, TAG_NODE_6C, TAG_PERFORMANCE, TAG_CODE],  # deprecated
    TRACE_NAME_CODE_CORRECTNESS: [TAG_EVALUATION, TAG_NODE_6D, TAG_CORRECTNESS, TAG_CODE],  # deprecated
    TRACE_NAME_CODE_EXECUTION: [TAG_EVALUATION, TAG_NODE_6C, TAG_PERFORMANCE, TAG_CORRECTNESS, TAG_CODE],
}
